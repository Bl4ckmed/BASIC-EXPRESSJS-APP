...
describe('p1', function() {
    it('p1 should return ', function(){
        ...
        // testing wrong input 
        assert.equal(pr1.p1('Bonjour',null),'Input conditions not satisfied')
...
describe('p2', function() {
    it('p2 should return ', function(){
        ...
        assert.equal(pr1.p1('2020-06-10','2020-07-25'),'15 jours')
        assert.equal(pr1.p1('2018-05-16','2020-09-03'),'42 jours')
